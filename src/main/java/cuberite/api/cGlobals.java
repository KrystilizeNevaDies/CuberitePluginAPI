...
public class cGlobals {
	...
	static class Base64Decode extends OneArgFunction { // TODO: Complete this class
		/**
		 *
		...
		@Override
		public LuaValue call(LuaValue value) {
			return valueOf(new String(Base64.getDecoder().decode(value.tojstring().getBytes())));
		}
	}

	static class Base64Encode extends OneArgFunction { // TODO: Complete this class
		/**
		 *
		...
		@Override
		public LuaValue call(LuaValue value) {
			return valueOf(new String(Base64.getEncoder().encode(value.tojstring().getBytes())));
		}
	}
